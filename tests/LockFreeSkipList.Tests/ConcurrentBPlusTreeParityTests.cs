...
public class ConcurrentBPlusTreeParityTests
{
    ...
    private static ConcurrentBPlusTree<int, int> EvenKeys(int order = 8)
    {
    ...
    {
        var d = new ConcurrentBPlusTree<int, int>(order: 4);
    ...
    {
        var d = new ConcurrentBPlusTree<string, int>(comparer: StringComparer.Ordinal);
    ...
    {
        var d = new ConcurrentBPlusTree<int, string>();
    ...
    {
        var d = new ConcurrentBPlusTree<int, int>(order: 8);
